...
const FooterSection: NextPage<FooterSectionType> = ({
  ...
  return (
    <div
      className="bg-dark-blue flex flex-row items-start justify-start py-10 px-20 box-border gap-[80px] [border-top:1px] [border-top-style:solid] border-t-darkslategray text-left text-[16.82px] text-white font-inter self-stretch lg:py-6 lg:px-5 lg:box-border lg:[border-top:1px] lg:[border-top-style:solid] lg:border-t-darkslategray lg:gap-[20px] md:flex-col md:p-10 md:box-border md:gap-[20px] md:mt-[30px] sm:py-[30px] sm:px-6 sm:box-border"
    >
      {/** This part is the logo design */}
      ...
      <div className="flex flex-grow items-center justify-center text-5xl font-bold text-white">
        Made with love for Padel
      </div>
