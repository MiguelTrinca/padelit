...
const NewsletterNew = () => {
    return (
      <div className="relative w-screen h-screen rounded-lg overflow-hidden flex flex-col items-center justify-center text-center text-dark-gray font-inter md:h-full">
        ...
        <div className="max-w-[600px] p-5 relative z-10">
          <div className="self-stretch flex flex-col items-center justify-start gap-[20px] relative">
            ...
            <div className="self-stretch relative leading-[24px] text-[20px] text-white md:text-lg">
              Sê um dos primeiros a se juntar ao Padelit e ganha estas <span className='text-bold text-accent-yellow'>recompensas</span>!
            </div>
